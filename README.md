...
| :---: | :---: |
| <img src="outputs/distribution_plot.png" width="100%"> | <img src="outputs/correlation_heatmap.png" width="100%"> |
| *Location: `outputs/distribution_plot.png`* | *Location: `outputs/correlation_heatmap.png`* |

| 🌐 Interactive Charts | 📈 Trend Analysis |
| :---: | :---: |
| <img src="outputs/interactive_plot.png" width="100%"> | <img src="outputs/trend_analysis.png" width="100%"> |
| *Location: `outputs/interactive_plot.png`* | *Location: `outputs/trend_analysis.png`* |
